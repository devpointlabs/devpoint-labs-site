          ...
          <Grid.Column>
            <CardStyle style={styles.cardSize2}>
              ...
              <Card.Description style={styles.descFont2}>
                A visual guide coult be a wireframe, creative composition, or
                imformation
                <br />
                architecture. A device that enables collaboration will lessen
                the chance
                <br />
                of work having to be completely redone. A manager could creat a
                visual
                <br />
        ...
        <Grid.Column mobile={16} tablet={8} computer={18}>
          <CardStyle1 style={styles.cardSize}>
            <Card.Header style={styles.headerFont3}>
              A Day in the life at DevPoint Labs
            </Card.Header>
            <Link to="/" style={styles.linkSize}>
              Action Link
            </Link>
          </CardStyle1>
        </Grid.Column>
