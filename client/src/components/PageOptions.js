    ...
    >
      ...
      <Grid.Row>
        ...
        <Grid.Column mobile={16} tablet={8} computer={5}>
          ...
          <p style={{ textAlign: "center", fontSize: "1.2em" }}>
            We're excited to offer two scholarships for our Full-Time ProEd Web
            Development and Part-Time Web Development classes.
          </p>
          <p
            style={{
              textAlign: "center",
        ...
        <Grid.Column mobile={16} tablet={8} computer={4}>
          ...
          <p style={{ textAlign: "center", fontSize: "1.2em" }}>
            The DevHouse - Fully furnished free student housing steps away from
            campus.
          </p>
          <p
            style={{
